...
As always, module help can be shown by adding the `-h` flag (as shown below). You can also show help for a specific mode by specifying the mode followed by `-h`, e.g. `fucyfuzz uds_fuzz seed_randomness_fuzzer -h` or `fucyfuzz uds_fuzz delay_fuzzer -h`
...
usage: fucyfuzz uds_fuzz [-h] {delay_fuzzer,seed_randomness_fuzzer} ...

UDS seed randomness fuzzer and tester module for Fucyfuzz
...
Example usage:
  fucyfuzz uds_fuzz seed_randomness_fuzzer 100311022701 0x733 0x633 -d 4 -r 1 -id 2 -m 0
  fucyfuzz uds_fuzz delay_fuzzer 100311022701 0x03 0x733 0x633
```
...
```
$ fucyfuzz uds_fuzz seed_randomness_fuzzer -h
...
usage: fucyfuzz uds_fuzz seed_randomness_fuzzer [-h] [-t ITERATIONS] [-r RTYPE] [-id RTYPE] [-m RMETHOD] [-d D]
                                             stype src dst
...
```
$ fucyfuzz uds_fuzz delay_fuzzer -h
...
usage: fucyfuzz uds_fuzz delay_fuzzer [-h] [-r RTYPE] [-d D] stype target src dst
