## How to use
The best way to understand how to use Fucyfuzz is to look at its help menu:
...
```
$ fucyfuzz -h
usage: fucyfuzz [-h] [-i INTERFACE] module ...
...
usage: fucyfuzz send message [-h] [--delay D] [--loop] msg [msg ...]
...
For instance, in oder to send the message `c0 ff ee` with arbitration ID `0xf00` on virtual CAN bus `vcan0`, you would run
    ...
    $ fucyfuzz -i vcan0 send message 0xf00#c0.ff.ee
...
## Example use
In this example we have connected a compatible [hardware](https://github.com/Fucyfuzz/fucyfuzz/blob/master/README.md#hardware-requirements) (PiCAN) to our client computer (a Raspberry Pi) and installed the software according to the [instructions](https://github.com/Fucyfuzz/fucyfuzz/blob/master/documentation/howtoinstall.md#raspberry-pi).
...
```
$ fucyfuzz uds discovery -min 0x003
...
```
$ fucyfuzz xcp discovery -min 0x003
...
For XCP you can get more information by running
    ...
    fucyfuzz xcp info 0x3e8 0x3e9

and you can try to dump parts of the memory by using

    fucyfuzz xcp dump 0x3e8 0x3e9 0x1f0000000 0x4800 -f bootloader.hex
