...
This module can be used to discover and utilize various diagnostics services. It is built upon the ISO 14229-1 protocol implementation in Fucyfuzz and
...
As always, module help can be shown by adding the `-h` flag (as shown below). You can also show help for a specific mode by specifying the mode followed by `-h`, e.g. `fucyfuzz uds discovery -h` or `fucyfuzz uds testerpresent -h`
...
Example usage:
  fucyfuzz uds discovery
  fucyfuzz uds discovery -blacklist 0x123 0x456
  fucyfuzz uds discovery -autoblacklist 10
  fucyfuzz uds services 0x733 0x633
  fucyfuzz uds ecu_reset 1 0x733 0x633
  fucyfuzz uds testerpresent 0x733
  ...
  fucyfuzz uds read_mem 0x733 0x633 --start_addr 0x0 --mem_length 0x1000 --mem_size 0x100 --outfile memory_0_1000_100
```
...
usage: fucyfuzz uds discovery [-h] [-min MIN] [-max MAX] [-b B [B ...]] [-ab N]
                           [-sv] [-d D]
...
usage: fucyfuzz uds services [-h] [-t T] src dst
...
Example use:
```
$ fucyfuzz uds services 0x7E0 0x7E8
...
usage: fucyfuzz uds subservices [-h] [-t T] dtype stype src dst
...
usage: fucyfuzz uds ecu_reset [-h] [-t T] type src dst
...
usage: fucyfuzz uds testerpresent [-h] [-d D] [-dur S] [-spr] src
...
usage: fucyfuzz uds dump_dids [-h] [-t T] [--min_did MIN_DID] [--max_did MAX_DID]
                           src dst
...
Example use:
```
$ fucyfuzz uds dump_dids 0x7E0 0x7E8
...
usage: fucyfuzz uds security_seed [-h] [-r RTYPE] [-d D] [-n NUM] stype level src dst
...
```
$ fucyfuzz uds security_seed -n 10 0x3 0x3 0x7E0 0x7E8
...
usage: fucyfuzz uds auto [-h] [-min MIN] [-max MAX] [-b B [B ...]] [-ab N] [-sv] [-d D] [-t T] [--min_did MIN_DID] [--max_did MAX_DID]
