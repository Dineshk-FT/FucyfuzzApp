...
#### Symptoms
Running `fucyfuzz` and specifying an interface via `-i` gives the following error:
...
### Missing python-can
#### Symptoms
Running `fucyfuzz` gives the following error message:
```
Traceback (most recent call last):
  File "fucyfuzz", line 5, in <module>
    import can
