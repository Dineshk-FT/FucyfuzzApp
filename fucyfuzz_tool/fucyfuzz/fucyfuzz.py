...
def available_modules():
    """
    Get a string showing available Fucyfuzz modules.
    Modules are listed in setup.py: entry_points['fucyfuzz.modules']
...
def main():
    ...
    try:
        ...
        # Catch any CAN-related or configuration errors
        if "interface" in str(e).lower() or "config" in str(e).lower():
            # This error is likely caused by missing python-can configuration or interface issues
            print("\n---\n\nCAN Interface Error: {0}".format(e))
