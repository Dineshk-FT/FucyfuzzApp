...
from fucyfuzz.utils.common import msg_to_candump_format, parse_int_dec_or_hex
from fucyfuzz.modules.send import FILE_LINE_COMMENT_PREFIX
...
def parse_args(args):
    ...
    """
    parser = argparse.ArgumentParser(prog="fucyfuzz dump",
                                     formatter_class=argparse.RawDescriptionHelpFormatter,
                                     description="CAN traffic dump module for Fucyfuzz",
