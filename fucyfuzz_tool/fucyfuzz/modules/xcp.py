from fucyfuzz.utils.can_actions import CanActions, auto_blacklist
...
def parse_args(args):
    ...
    """
    parser = argparse.ArgumentParser(prog="fucyfuzz xcp",
                                     formatter_class=argparse.RawDescriptionHelpFormatter,
                                     description="""XCP module for Fucyfuzz""",
                                     epilog="""Example usage:
  fucyfuzz xcp discovery
  fucyfuzz xcp discovery -blacklist 0x100 0xabc
  fucyfuzz xcp discovery -autoblacklist 10
  fucyfuzz xcp commands 0x3e8 0x3e9
